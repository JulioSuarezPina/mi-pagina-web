...
const Data = () => {
    return (
        <div className='home__data'>
            <h1 className='home__title'>Julio Suárez
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Estudiante de Ing. Informática</h3>
            <p className="home__description">Entusiasmado por desarrollar mis habilidades con nuevos retos.</p>
